...
import com.fusecoords.drivedroid.Authority.User.Companion.DB_IMAGE_PATH
import com.fusecoords.drivedroid.Authority.User.Companion.DB_USER_PATH
                    ...
                    .addOnCompleteListener(this@SignupActivity) { task ->
                        ...
                        if (!task.isSuccessful) {
                            ...
                            if (immagex != null) {
                                var mStorage: StorageReference =
                                    FirebaseStorage.getInstance()
                                        .getReference(DB_IMAGE_PATH + "/" + FirebaseAuth.getInstance().currentUser!!.uid + ".png")
                            ...
                            var mDatabase: DatabaseReference =
                                FirebaseDatabase.getInstance().getReference(DB_USER_PATH)
                            mDatabase.child(FirebaseAuth.getInstance().currentUser!!.uid)
                                ...
                                .addOnCompleteListener(OnCompleteListener {
                                    if (it.isSuccessful) {
                                        ...
                                        Toast.makeText(
                                            this@SignupActivity, "Register update failed.",
                                            Toast.LENGTH_SHORT
                                        ).show()
                                    }
                                })
